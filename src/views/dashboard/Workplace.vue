 ...
 * @LastEditTime: 2020-5-22 17:45:35
 * @LastEditors: Please set LastEditors
 * @Description: 验证动态权限(用户操作)
 * @FilePath: \src\views\dashboard\Workplace.vue
 -->
<template>
        ...
        <a-col
          ...
          <a-card title="快速开始 / 便捷导航" style="margin-bottom: 24px" :bordered="false" :body-style="{padding: 0}">
            <div class="item-group">
              ...
              <a>操作四</a>
              <a>操作五</a>
              <a v-action:add>操作六</a>
              <a-button v-action:add size="small" type="primary" ghost icon="plus">添加</a-button>
            </div>
          </a-card>
