 ...
 * @LastEditTime:-11-04 11:20:52
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: .\src\views\dashboard\Analysis.vue
 -->
<template>
  <div class="page-header-index-wide">
    <a-row :gutter="24">
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
        <chart-card :loading="loading" :title="'总销售额(' + $t('dashboard.workplace.project') + ')'" total="￥126,560">
        ...
        <a-tabs default-active-key="1" size="large" :tab-bar-style="{marginBottom: '24px', paddingLeft: '16px'}">
          <div class="extra-wrapper" slot="tabBarExtraContent">
            <div class="extra-item">
              ...
              <a>本月</a>
              <a>本年</a>
              <a-button v-if="$auth('dashboard.add')" v-action:add >添加用户</a-button>
            </div>
